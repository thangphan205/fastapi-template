...
def create_user(
    ...
    return {
        ...
        "message": "{} create user {} - role {} FAIL.".format(
            current_user.username, result.username, result.role
        ),
    }
...
def read_user_me(
    ...
    current_user_response = {
        ...
        "status": "ok",
        "type": "account",
        "currentAuthority": current_user.role,
...
def delete_user(
    ...
    logger.error(
        "User {} delete user {} FAIL.".format(current_user.username, db_user.username)
    )
    return {
        "success": False,
        "data": result,
